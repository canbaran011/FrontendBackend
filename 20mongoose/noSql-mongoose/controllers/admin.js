...
exports.getProducts = (req, res, next) => {
    Product
        .find() //.find({name: 'Iphone 6' , price: 2000 , }) .limit(10) .select({name:1 , price:1}) .sort({name:1})
...
exports.postEditProduct = (req, res, next) => {
    ...
    Product.updateOne({ _id: id }, //deprecated use updatOne
        {
            $set: {
                name: name,
                price: price,
...
exports.postDeleteProduct = (req, res, next) => {
    ...
    Product.deleteOne({ _id: id }) //findByIdAndRemove(id)
        .then(() => {
